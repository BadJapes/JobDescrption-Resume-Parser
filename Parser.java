...
public class Parser{
	...
	public final static String DELIMITERS_FILE = "delimiters.txt";
	public final static String KEYWORDS_FILE = "keywords.txt";
	public final static String VERBS_FILE = "verbs.txt";
